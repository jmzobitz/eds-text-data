...
- `lwc_2023.csv`: Daily reported weatherstation data from Lawrence, Kansas. Processed from the [Iowa Environmental Mesonet](https://mesonet.agron.iastate.edu/request/download.phtml?network=KS_ASOS), station "LWC" 
  - Variables:
 ...
 - `msp_2023.csv`: Daily reported weatherstation data from Minneapolis/St. Paul, Minnesota. Processed from the [Iowa Environmental Mesonet](https://mesonet.agron.iastate.edu/request/download.phtml?network=MN_ASOS), station "MSP" 
    - Variables:
      - `station`: Weather station
      - `day`: POSIXct date (daily)
      - `max_temp_f`: Maximum temperature (F)
